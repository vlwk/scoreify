    ...
    <div className="bg-white shadow-lg rounded-lg p-6">
      ...
      <div className="flex items-center mb-4">
        <div className="flex items-center mr-6">
          ...
          />
          <label htmlFor="group1" className="ml-2 text-gray-700">
            Group 1
          </label>
        </div>
        <div className="flex items-center">
          <input
            ...
            className="form-checkbox h-5 w-5 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
          />
          <label htmlFor="group2" className="ml-2 text-gray-700">
            Group 2
          </label>
        </div>
      </div>
        ...
        {filteredTeams.map((team) => (
          ...
          >
            ...
            <div className="text-sm text-gray-600">
              Registered: {team.registered_date.slice(0, 2)}/
              {team.registered_date.slice(2, 4)}
            </div>
            <div className="text-sm text-gray-600">
